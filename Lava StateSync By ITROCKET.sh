#!/bin/bash
echo "Настроим StateSync? Нажми любую клавишу"
read -n 1 -s
echo "Останавливаю сервис! Нажми любую клавишу"
read -n 1 -s
sudo systemctl stop lava.service

echo "Сохраняю Vaidator State и делаю Сброс и очистку ноды! Нажми любую клавишу"
read -n 1 -s
cp $HOME/.lava/data/priv_validator_state.json $HOME/.lava/priv_validator_state.json.backup
lavad tendermint unsafe-reset-all --home $HOME/.lava --keep-addr-book

echo "Добавляю Peers! Нажми любую клавишу"
read -n 1 -s
...
echo "Вычисляю нужный нам блок! Нажми любую клавишу"
read -n 1 -s
...
echo "Возвращаю Validator State! Нажми любую клавишу"
read -n 1 -s
mv $HOME/.lava/priv_validator_state.json.backup $HOME/.lava/data/priv_validator_state.json

echo "Готово! Запускаю ноду и журнал! Нажми любую клавишу"
read -n 1 -s
